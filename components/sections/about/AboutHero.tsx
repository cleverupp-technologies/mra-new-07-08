...
export function AboutHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#FAF8F1] text-[#111827] border-b border-[#FFD978]/40">
      ...
      <div className="lg:hidden relative min-h-[75vh] max-h-[760px] w-full flex flex-col justify-center px-6 sm:px-8 pt-32 sm:pt-36 pb-10 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          />
          {/* Shared Soft Cream Hero Overlay */}
          <HeroOverlay />
        </div>
        ...
        <div className="relative z-20 space-y-4">
          ...
          <nav aria-label="Breadcrumb" className="mb-2">
            <ol className="flex items-center space-x-2 text-xs font-sans text-[#4B5563]">
              <li>
                <Link href="/" className="hover:text-[#1F3A8A] transition-colors">
                  Home
                </Link>
              </li>
              <li aria-hidden="true">
                <span className="text-[#4B5563]/60">/</span>
              </li>
              <li className="font-semibold text-[#1F3A8A]" aria-current="page">
                About
              </li>
            </ol>
          </nav>
          ...
          <div>
            <p
              role="heading"
              aria-level={1}
              className="font-serif font-bold text-[34px] sm:text-[42px] text-[#111827] leading-[1.05] tracking-tight max-w-[340px] transition-all duration-700 ease-out"
              style={{
          ...
          <div className="pt-2">
            <p
              className="font-sans text-[#4B5563] text-sm sm:text-base font-normal leading-relaxed max-w-[310px] border-l-2 border-[#F4B942] pl-3 py-0.5 transition-all duration-700 ease-out"
              style={{
                opacity: isLoaded ? 1 : 0,
                transform: isLoaded ? "translateY(0)" : "translateY(20px)",
        ...
        >
          <a
            ...
            className="text-[#111827]/75 hover:text-[#1F3A8A] active:text-[#1F3A8A] transition-all duration-250 ease-out hover:scale-105 active:scale-105 p-1.5 focus-visible:outline-2 focus-visible:outline-[#1F3A8A] rounded-sm"
          >
          ...
          <div className="w-px h-[50px] bg-[#111827]/30 mt-2 pointer-events-none" aria-hidden="true" />
        </div>
      </div>
      ...
      <div className="hidden lg:flex pt-[160px] pb-28 min-h-[92vh] flex-col justify-center relative">
        ...
        >
          <a
            ...
            rel="noopener noreferrer"
            aria-label="LinkedIn Profile"
            className="text-[#111827]/70 hover:text-[#1F3A8A] transition-colors duration-250 focus-visible:outline-2 focus-visible:outline-[#1F3A8A] p-1"
          >
        ...
        <Container className="relative z-20">
          <div className="max-w-[640px] space-y-6">
            ...
            {/* Headline */}
            <h1
              className="font-serif font-bold text-[clamp(2.8rem,4vw,3.8rem)] text-[#111827] leading-[1.05] tracking-[-0.02em] transition-all duration-800 motion-reduce:transition-none"
              style={{
                opacity: isLoaded ? 1 : 0,
            ...
            {/* Supporting Paragraph */}
            <p
              className="mt-6 font-sans text-[#4B5563] text-lg font-normal leading-relaxed border-l-2 border-[#F4B942] pl-4 py-1 transition-all duration-800 motion-reduce:transition-none"
              style={{
                opacity: isLoaded ? 1 : 0,
                transform: isLoaded ? "translateY(0)" : "translateY(24px)",
                transitionTimingFunction: "cubic-bezier(0.16, 1, 0.3, 1)",
