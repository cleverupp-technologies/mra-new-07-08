 ...
 * V2 Industry Data
 *
 * Source of truth for all V2 industry records.
 * Accessed only through src/content/v2/repository.ts — never imported directly by pages.
 *
 * DATA INTEGRITY RULES:
 * - verifiedClientCount: omit if unknown — never use 0, "0+", or invented numbers
 * - experienceContext: factual observations only — no marketing claims
 * - Only healthcare has detailed data at launch; other industries have minimal
 *   but architecturally complete records ready to be fleshed out.
 */
